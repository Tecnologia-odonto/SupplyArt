        ...
        if (requestId) {
          ...
          if (allEmRotaItems) {
            ...
            if (allDelivered) {
              ...
              // Marcar pedido como recebido (SEM CONSUMIR ORÇAMENTO AINDA)
              ...
              toast.success('🎉 Todos os itens do pedido foram entregues! Aguardando confirmação final da unidade.');
            }
          }
        }
